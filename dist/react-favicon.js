...
var Favicon = function (_React$Component) {
  ...
  _createClass(Favicon, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.url === this.props.url && prevProps.animated === this.props.animated && prevProps.alertCount === this.props.alertCount && prevProps.keep === this.props.keep) return;
    ...
    value: function draw() {
      ...
      if (typeof linkEl === 'undefined') {
        ...
        for (var i = links.length; --i >= 0;) {
          if (/\bicon\b/i.test(links[i].getAttribute("rel")) && !activeInstance.props.keep(links[i])) {
